...
const contractABI = require("../artifacts/contracts/Scalezephyr.sol/Scalezephyr.json").abi;

program
    .name("scalezephyr-cli")
    .description("CLI tool for Scalezephyr smart contract")
    .version("1.0.0");
