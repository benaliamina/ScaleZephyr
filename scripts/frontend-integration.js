 ...
 * This file demonstrates how to integrate Scalezephyr with a web frontend
 */

// For React/Vue/Angular applications
export class ScalezephyrClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ScalezephyrClient(provider, contractAddress);
